...
// Demo site: QA Validation Demo Form - a real working form for testing
const initialSites: Site[] = [
  {
    id: 'demo-qavalidation',
    name: 'QA Validation Demo Form',
    description: 'Full demo site for testing form automation - https://qavalidation.com/demo-form/',
    status: 'active',
...
const initialFields: FormField[] = [
  ...
  },
  {
    ...
    fieldType: 'textarea',
    value: '123 Automation Street, Test City, QA 12345',
  ...
  },
  {
    ...
    value: '',
    columnMapping: null,
    enabled: false, // Disabled by default to prevent accidental submission
    runJs: false,
    jsCode: null,
    waitForElement: true,
    executeOnMultiple: false,
...
const initialLogs: LogEntry[] = [
  {
    ...
    action: 'info',
    message: 'Demo site ready for testing',
