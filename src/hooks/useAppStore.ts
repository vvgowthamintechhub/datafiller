...
// Initial mock data (includes one real, stable demo page for testing)
const initialSites: Site[] = [
  {
    id: 'demo-w3',
    name: 'W3Schools Contact Form (Demo)',
    description: 'Use this to test highlight + fill (stable IDs).',
    status: 'active',
...
const initialPages: SitePage[] = [
  {
    id: 'demo-w3-page',
    siteId: 'demo-w3',
    url: 'w3schools.com/howto/howto_css_contact_form.asp',
    matchType: 'contains',
    index: 0,
    active: true,
    fieldsCount: 5,
...
const initialFields: FormField[] = [
  ...
  },
  {
    ...
    name: 'Submit',
    selectorType: 'xpath',
    selectorQuery: "//input[@type='submit']",
    fieldType: 'button',
    value: '',
    columnMapping: null,
    enabled: true,
